...
export default {
  ...
  //   Header Paragraph
  headerParagraph:
    "Graduate M.Sc in Computational Cognitive Neuroscience. I love the essence of problem‐solving and I am constantly learning new technologies. A team player who loves to collaborate, lead and motivate to reach project goals.",

  //Contact Email
  contactEmail: "nayanthapan@yahoo.com",
  ...
  projects: [
    {
      ...
      title: "Smart Watch Shopping Cart.", //Project Title - Add Your Project Title Here
      para:
        "Website for a smartwatch seller.", // Add Your Service Type Here
  ...
  social: [
    ...
    { img: githubIcon, url: "https://github.com/NyanoNyan" },
    {
      img: twitterIcon,
      url: "https://twitter.com/greenNayan",
    },
  ],
